...
import cafe_shtin.users.models
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uuid', models.UUIDField(null=True, unique=True, verbose_name='Идентификатор в СБИС престо')),
                ('username', models.CharField(max_length=50, verbose_name='Имя пользователя')),
                ('password', models.CharField(max_length=128, null=True, verbose_name='Пароль')),
                ('cashback', models.IntegerField(blank=True, default=0, verbose_name='Накопленный кешбек')),
            ...
            managers=[
                ('objects', cafe_shtin.users.models.MyUserManage()),
            ],
        ),
        migrations.CreateModel(
            name='AddressUser',
